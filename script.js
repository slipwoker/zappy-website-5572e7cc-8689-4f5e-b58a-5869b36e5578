  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        if (validators[ruleName] && !validators[ruleName](field.value, ruleParam)) {
          showError(field, getErrorMessage(field, ruleName, ruleParam));
          return false;
        }
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5572e7cc-8689-4f5e-b58a-5869b36e5578',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5572e7cc-8689-4f5e-b58a-5869b36e5578';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5572e7cc-8689-4f5e-b58a-5869b36e5578';
